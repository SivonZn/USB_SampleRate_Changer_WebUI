...
export function BluetoothHalCard(props: {
  ...
  return <article class="card tool-panel">
    ...
    <div class="inline-actions"><button class="secondary-button" disabled={props.busy || !props.canReset} onClick={props.onReset}>{props.toolAction === "bluetooth-hal-reset" ? props.tx("common.working") : props.tx("common.reset")}</button><button class="primary-button" disabled={props.busy || !props.canApply} onClick={props.onApply}>{props.toolAction === "bluetooth-hal" ? props.tx("common.working") : props.tx("common.apply")}</button></div>
  </article>;
}
